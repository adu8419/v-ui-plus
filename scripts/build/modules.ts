...
import { VuiPlusAlias, VuiPlusExternal, VuiPlusClearConsole } from "../utils/plugin"
          ...
          ? [
              ...
              dts({
                ...
                beforeWriteFile: (filePath: string, content: string) => {
                  ...
                  // packages/v-ui-plus
                  if (filePath.includes("dist/types/v-ui-plus")) {
                    tempPath = filePath.replace("dist/types/v-ui-plus", "dist/types")
                  }
