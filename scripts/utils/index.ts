...
export const PKG_NAME = 'v-ui-plus'

export const PKG_CAMEL_CASE_NAME = 'VuiPlus'

export const PKG_PREFIX = '@v-ui-plus'

export const PKG_CAMEL_CASE_LOCAL_NAME = 'VuiPlusLocale'
